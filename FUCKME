...
function WindowTable:CreateWindow(name)
	...
	allPages.Size = UDim2.new(0, 306, 0, 244)
	...
	TopBar.BackgroundColor3 = Color3.fromRGB(45, 48, 53)
	...
	HubName.Position = UDim2.new(0.0116279088, 0, 0, 0)
	HubName.Size = UDim2.new(0, 110, 0, 29)
	HubName.Font = Enum.Font.SourceSansSemibold
	HubName.Text = name
	HubName.TextColor3 = Color3.fromRGB(255, 255, 255)
	HubName.TextSize = 19.000
	...
	CloseButton.Position = UDim2.new(0.920930088, 0, 0, 0)
	CloseButton.Size = UDim2.new(0, 34, 0, 29)
